...
public class ApiController {
	...
	@GetMapping("/api")
	public String airReg(@RequestParam (value ="sido", defaultValue = "서울", required = false )String sido, Model model) throws IOException {
        ...
        urlBuilder.append("&" + URLEncoder.encode("sidoName","UTF-8") + "=" + URLEncoder.encode(sido, "UTF-8")); /*시도*/
